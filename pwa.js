...
const cacheName = 'midtermSupplement-2020-10-23 08:42:13.013076'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'midtermSupplement'.length) === 'midtermSupplement') {
